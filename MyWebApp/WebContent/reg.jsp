...
<body>
	...
	<%
		...
		try {
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/proj2016?autoReconnect=true", "root",
					"WeHearKK290");
		...
		if (rs.next()) {
			...
			int i = stmt.executeUpdate("insert into users values ('" + account_id + "','" + fullname + "','"
